const MenuConfig = {
    ...
    roleMap: {
        STUDENT: [
            ...
            { id: 'events', label: 'Events', icon: 'calendar-days', color: 'bg-purple-500', file: 'modules/common/events.js' },
            { id: 'library', label: 'Library', icon: 'library-big', color: 'bg-stone-600', file: 'modules/common/library.js' },
            { id: 'about', label: 'About', icon: 'info', color: 'bg-blue-500', file: 'modules/common/about.js' },
            { id: 'support', label: 'Help', icon: 'headset', color: 'bg-teal-600', file: 'modules/common/support.js' }
        ],
    ...
    roleResolver(designation = '') {
        ...
        if (d.includes('TEACH')) return 'TEACHER';
