        ...
        items.sort((a, b) => b.timestamp - a.timestamp).forEach(hw => {
            ...
            <div class="bg-white rounded-[28px] p-5 mb-4 shadow-sm border border-slate-100 relative overflow-hidden active:scale-[0.98] transition-transform">
                ...
                <div class="flex justify-between items-start mb-3">
                    ...
                    <div class="flex items-center gap-1 text-[9px] font-black text-indigo-500 bg-indigo-50 px-2 py-1 rounded-lg">
                        <i data-lucide="circle-user" class="w-3 h-3"></i> MY POST
                    </div>
                </div>
                ...
                ${hw.editedBy ? `
                    <div class="flex items-center gap-2 bg-emerald-50 text-emerald-700 p-2 rounded-xl mb-4 border border-emerald-100">
                        ...
                        <span class="text-[9px] font-bold uppercase tracking-tighter">Verified/Edited by Admin</span>
                    </div>
                ` : ''}
                ...
                <div class="mt-3 flex justify-between items-center opacity-40">
                    <span class="text-[8px] font-bold uppercase tracking-widest text-slate-500">Teacher: ${hw.teacherName}</span>
                    <i data-lucide="check-circle-2" class="w-3 h-3 text-indigo-500"></i>
                </div>
            </div>`;
        });
