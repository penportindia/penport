...
window.render_att_view = async function(user) {
    ...
    try {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            let displayValue = `<span class="text-xs font-bold">${day}</span>`;
            ...
            if (status === 'P') {
                ...
                displayValue = `<span class="text-[9px] font-black">${day}</span>`;
            }
        ...
        container.innerHTML = `
            <div class="mt-10 px-6 pb-12 max-w-md mx-auto animate-fade-in">
