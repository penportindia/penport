...
window.render_homework = async function (user) {
    ...
    const styleInject = `
        <style>
            ...
            /* Left blue color line removed from here */
            ...
            .task-content { 
                color: #334155; font-size: 16px; font-weight: 500; line-height: 1.7; margin: 20px 0;
        ...
        const html = sortedItems.map(hw => {
            ...
            <div class="hw-card bg-white rounded-3xl p-5 shadow-sm border border-slate-100">
                ...
                <div class="mb-5">
                    ...
                    <div class="task-content w-full text-slate-700 leading-relaxed bg-slate-50 p-4 rounded-2xl whitespace-pre-wrap">
                        ${hw.task}
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2 mb-5">
                    <div class="flex items-center gap-1.5 opacity-70">
                        ...
                        <span class="text-[10px] font-bold uppercase tracking-tighter text-slate-500">Posted by: ${hw.teacherName}</span>
                    </div>
                    ${hw.editedBy ? `
                        <div class="flex items-center gap-2 bg-emerald-50 text-emerald-700 p-2.5 rounded-xl border border-emerald-100">
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-tighter text-emerald-600">Modified by: ${hw.editedBy}</span>
                        </div>
                    ` : ''}
                </div>
