...
window.noticeStyles = window.noticeStyles || `
    <style>
        ...
        .header-module { 
            ...
            margin-bottom: 20px; box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.03); 
        }
        .header-top { 
        ...
        .search-box input { 
            ...
            background: var(--primary-light); font-weight: 600; outline: none; 
        }
        .btn-create { 
            background: var(--primary); color: white; padding: 10px 18px; border-radius: 12px; 
        ...
        .pin-badge { 
            ...
            color: white; padding: 4px 10px; border-radius: 20px; font-size: 9px; 
            font-weight: 800; 
        }
        ...
        .notice-content { 
            font-size: 13px; color: var(--text-sec); line-height: 1.5; margin-bottom: 15px; 
        ...
        .download-overlay { 
            ...
            align-items: center; justify-content: center; color: white; opacity: 0; transition: 0.2s; 
        }
        ...
        .avatar-small { 
            width: 32px; height: 32px; background: var(--primary); color: white; border-radius: 8px; 
        ...
        .upload-status-item { 
            display: flex; align-items: center; gap: 8px; background: #fff; padding: 10px; 
            border-radius: 10px; border: 1px solid var(--border); margin-top: 5px; 
        }
        ...
        .input-v3 { 
            ...
            background: var(--primary-light); font-weight: 600; font-size: 13px; margin-bottom: 10px; 
        }
        ...
        .label-text { 
            font-size: 13px; font-weight: 500; color: #666; margin-bottom: 6px; 
...
window.openNoticeModal = async function() {
    ...
    const { value: form } = await Swal.fire({
        ...
        html: window.noticeStyles + modalHTML,
        preConfirm: () => {
            const data = {
            ...
            if (Object.keys(window.noticeCurrentUploadXHRs).length > 0) return Swal.showValidationMessage('Uploading...');
            return data;
        }
    });
