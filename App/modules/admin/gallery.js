        ...
        <div class="post-card p-2 sm:p-4 animate-in fade-in slide-in-from-bottom-10 duration-500 mb-4 bg-white rounded-3xl shadow-sm">
            <div class="flex items-center gap-4 p-4">
                ...
                ${post.userPhone === myPhone ? `
                    <button onclick="deletePost('${post.id}')" class="text-slate-200 hover:text-rose-500 p-2 transition-colors">
...
window.toggleLike = function(postId, phone) {
...
window.postComment = async function(postId, phone) {
