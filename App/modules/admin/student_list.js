window.render_student_list = async function(user) {
    ...
    window.fetchStudentsByQuery = async () => {
        ...
        try {
            ...
            filtered.sort((a, b) => {
                const rollA = a.academic?.rollNo;
                const rollB = b.academic?.rollNo;
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="flex gap-1">
                                <span class="text-[9px] font-black bg-slate-100 text-slate-600 px-2 py-0.5 rounded-md">R: ${s.academic.rollNo || '0'}</span>
                        ...
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    <p class="text-xs font-bold text-slate-500 tracking-wider">Roll: ${s.academic.rollNo || '0'}</p>
