            ...
            if (routeId && transportAmounts[routeId]) {
                ...
                <div class="bg-amber-50/50 border border-amber-100 rounded-[2.5rem] p-6 mb-4 relative overflow-hidden group">
                    ...
                    <div class="relative z-10 flex justify-between items-center">
                        <div class="space-y-3">
                            <h5 class="text-xs font-black text-amber-700 uppercase tracking-[0.2em]">Transport</h5>
                            <div class="flex items-center gap-2">
            ...
            <div class="max-w-xl mx-auto pt-8 space-y-10 pb-32 px-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <div class="relative overflow-hidden rounded-[3rem] shadow-2xl transition-all duration-700 ${isAdvance ? 'bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-700' : 'bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900'} p-8">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="grid grid-cols-2 gap-2 sm:gap-4 mt-6 sm:mt-12 pt-4 sm:pt-8 border-t border-white/20">
    
                            <div class="text-center p-2 sm:p-3 rounded-lg sm:rounded-xl bg-white/5 backdrop-blur-sm border border-white/5">
                                <p class="text-[9px] sm:text-[11px] font-bold text-yellow-400 uppercase tracking-wider mb-1 sm:mb-2 leading-tight">
                                    Total Billed
                                </p>
                                <p class="text-base sm:text-2xl font-bold text-white break-words leading-tight">
                                    ₹${totalBilledToDate.toLocaleString()}
                                </p>
                            </div>

                            <div class="text-center p-2 sm:p-3 rounded-lg sm:rounded-xl bg-emerald-500/10 backdrop-blur-sm border border-emerald-500/10">
                                <p class="text-[9px] sm:text-[11px] font-bold text-yellow-400 uppercase tracking-wider mb-1 sm:mb-2 leading-tight">
                                    Total Paid
                                </p>
                                <p class="text-base sm:text-2xl font-bold text-emerald-400 break-words leading-tight">
                ...
                <section>
                    <div class="flex items-center justify-between mb-6 px-4">
                        <h3 class="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em]">Ledger</h3>
