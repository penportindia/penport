if (window.__NOTICE_MODULE_LOADED__) {
    resetNoticeModule();
} else {
    window.__NOTICE_MODULE_LOADED__ = true;
    ...
    window.noticeStyles = window.noticeStyles || `
        <style>
           ...
           .erp-notice-panel{background:var(--bg);min-height:100vh;padding:20px;padding-top:40px;font-family:'Plus Jakarta Sans',sans-serif;color:var(--text-main);}
    ...
    function resetNoticeModule() {
        ...
        noticeCurrentUploadXHRs = {};
        window.__NOTICE_MODULE_ACTIVE = false;
    }
}